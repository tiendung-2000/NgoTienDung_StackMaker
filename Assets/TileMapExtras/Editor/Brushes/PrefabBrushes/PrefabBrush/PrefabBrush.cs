    ...
    public class PrefabBrush : BasePrefabBrush
    {
        ...
        public class PrefabBrushEditor : BasePrefabBrushEditor
        {
            ...
            public override void OnPaintInspectorGUI()
            {
                ...
                prefabBrush.m_Orientation = EditorGUILayout.Vector3Field("Orientation", prefabBrush.m_Orientation);
                prefabBrush.m_Rotation = Quaternion.Euler(prefabBrush.m_Orientation);
